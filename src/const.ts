...
export const LOCATION = "인천 CN웨딩홀 (계산점), 5층"
...
export const BRIDE_FATHER = "아버지성함"
export const BRIDE_MOTHER = "어머니성함"
...
export const GROOM_FATHER = "아버지성함"
export const GROOM_MOTHER = "어미니성함"
